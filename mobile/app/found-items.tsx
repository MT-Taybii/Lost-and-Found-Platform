        ...
        {foundItems.length === 0 ? (
          ...
          foundItems.map((item: any) => (
            <View key={item.id} style={styles.itemCard}>
              ...
              <Text style={styles.itemLabel}>Location Found:</Text>
              <Text style={styles.itemText}>{item.location}</Text>
              <Text style={styles.itemLabel}>Finder Name:</Text>
              <Text style={styles.itemText}>{item.finderName}</Text>
            </View>
          ))
        )}
      </ScrollView>
